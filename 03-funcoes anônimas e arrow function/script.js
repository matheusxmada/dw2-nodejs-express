...
// FUNÇÃO SETA - COM UM ÚNICO PARÂMETRO, É POSSÍVEL REMOVER O PARÊNTESES - ARROW FUNCTION
const triplo = (y) => {
  return y * 3;
};
const y = 100;
...
const operador = "*";
const num2 = 2;
// Experimente substituir tanto os valores quanto as operações
